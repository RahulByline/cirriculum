/*
  # Complete curriculum update with all 3 levels

  1. Updates
    - Add complete curriculum data for all 3 levels (Ages 3-4, 4-5, 5-6)
    - Include all 18 regular books (6 per level)
    - Include all 3 practice books (1 per level for each subject)
    - Total: 21 books across 3 levels

  2. Structure
    - Level 1: 6 regular books + 3 practice books
    - Level 2: 3 regular books + 2 practice books  
    - Level 3: 4 regular books + 2 practice books
*/

-- Update the curriculum configuration with complete data for all 3 levels
