/*
  # Update curriculum with complete data including lessons and objectives

  1. Changes
    - Replace existing curriculum data with complete structure
    - Include all 9 books with detailed units, lessons, and objectives
    - Ensure proper data structure for the application

  2. Data Structure
    - 6 Student Books with comprehensive content
    - 3 Practice Books with detailed exercises
    - All lessons include specific learning objectives
    - ISBN numbers and hyperlinks included
*/

-- Update the curriculum configuration with complete data structure
