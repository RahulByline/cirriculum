/*
  # Add Missing Practice Books

  1. Updates
    - Add missing practice books to Level 2 and Level 3
    - Each level should have 3 practice books
    - Level 2: Add Food & Nutrition Practice Book
    - Level 3: Add World Cultures Practice Book and Creative Expression Practice Book

  2. Structure
    - Level 1: 6 regular + 3 practice = 9 books
    - Level 2: 3 regular + 3 practice = 6 books  
    - Level 3: 4 regular + 3 practice = 7 books
    - Total: 22 books across all levels
*/

-- Update the curriculum data to include all missing practice books
  ...
  },
  {
    ...
    "books": [
          ...
          },
          {
            ...
            "lessons": [
              ...
              },
              {
                ...
                "objective": "Students will understand how community services support daily life"
              },
              {
                "id": "lesson108",
          ...
          },
          {
            ...
            "lessons": [
              ...
              },
              {
                ...
                "objective": "Students will learn safety rules for all types of transportation"
              }
            ]
          }
        ]
      },
      {
        "id": "l2b3",
        "name": "Food & Nutrition",
        "description": "Healthy eating, food groups, and nutrition basics",
        "isbn": "978-1-234567-12-2",
        "hyperlink": "https://example.com/food-nutrition",
        "units": [
          {
            "id": "unit38",
            "name": "Food Groups",
            "lessons": [
              {
                "id": "lesson115",
                "name": "Fruits and Vegetables",
                "objective": "Students will identify various fruits and vegetables and understand their health benefits"
              },
              {
                "id": "lesson116",
                "name": "Grains and Proteins",
                "objective": "Students will learn about grains and protein sources for energy and growth"
              },
              {
                "id": "lesson117",
                "name": "Dairy and Healthy Fats",
                "objective": "Students will understand the role of dairy and healthy fats in nutrition"
              }
            ]
          },
          {
            ...
            "lessons": [
              {
                "id": "lesson118",
                "name": "Balanced Meals",
                "objective": "Students will learn to create balanced meals with foods from all groups"
              },
              {
                "id": "lesson119",
                "name": "Healthy Snacks",
                "objective": "Students will identify nutritious snack options and understand portion sizes"
              },
              {
                "id": "lesson120",
                "name": "Food Safety",
                "objective": "Students will learn basic food safety and hygiene practices"
              }
            ]
          }
        ]
      },
      {
        ...
        "description": "Advanced English language skills and reading comprehension",
        ...
        "units": [
          {
            ...
            "lessons": [
              ...
              },
              {
                ...
                "objective": "Students will read and understand simple sentences with confidence"
              },
              {
                "id": "lesson123",
                "name": "Story Comprehension",
                "objective": "Students will demonstrate understanding of short stories through questions and discussion"
              }
            ]
          },
          {
            ...
            "lessons": [
              {
                ...
                "objective": "Students will write letters correctly with proper spacing and alignment"
              },
              {
                "id": "lesson125",
                "name": "Word Writing",
                "objective": "Students will write simple words independently with correct spelling"
              },
              {
                "id": "lesson126",
                "name": "Sentence Building",
                "objective": "Students will construct simple sentences using proper capitalization and punctuation"
              }
            ]
          }
        ]
            ...
            "lessons": [
              {
                "id": "lesson127",
                "name": "Numbers 1-20",
                "objective": "Students will work confidently with numbers up to 20"
              },
              {
                "id": "lesson128",
                "name": "Simple Addition",
                "objective": "Students will solve basic addition problems using manipulatives"
              },
              {
                "id": "lesson129",
                "name": "Simple Subtraction",
                "objective": "Students will understand subtraction as taking away and solve simple problems"
              }
            ]
          },
          {
            ...
            "lessons": [
              {
                ...
                "objective": "Students will compare objects by length, height, and weight"
              },
              {
                "id": "lesson131",
                "name": "Shape Sorting",
                "objective": "Students will classify shapes by their attributes and properties"
              },
              {
                "id": "lesson132",
                "name": "Pattern Making",
                "objective": "Students will create and extend complex patterns using various attributes"
              }
            ]
          }
        ]
      ...
      {
        "id": "l2p3",
        "name": "Practice Book - Nutrition & Health",
        "description": "Practical exercises for healthy living and nutrition awareness",
            ...
            "lessons": [
              {
                ...
                "objective": "Students will categorize foods as healthy or unhealthy choices"
              },
              {
                "id": "lesson134",
                "name": "Food Group Sorting",
                "objective": "Students will sort foods into appropriate food groups"
              },
              {
                "id": "lesson135",
                "name": "Meal Planning",
                "objective": "Students will plan balanced meals using foods from all groups"
              }
            ]
          },
          {
            ...
            "lessons": [
              {
                ...
                "objective": "Students will identify different types of physical activities and their benefits"
              },
              {
                "id": "lesson137",
                "name": "Hygiene Practices",
                "objective": "Students will practice proper hygiene routines and understand their importance"
              },
              {
                "id": "lesson138",
                "name": "Sleep and Rest",
                "objective": "Students will understand the importance of adequate sleep for health and growth"
              }
            ]
          }
        ]
    ...
    "books": [
      {
        ...
        "hyperlink": "https://example.com/our-world",
        "units": [
          {
            "id": "unit46",
            ...
            "lessons": [
              {
                ...
                "objective": "Students will learn to read simple maps and understand basic geography concepts"
              },
              {
                "id": "lesson140",
                "name": "Land and Water",
                "objective": "Students will identify different landforms and bodies of water"
              },
              {
                "id": "lesson141",
                "name": "Our Country and State",
                "objective": "Students will learn about their country and state within the larger world"
              }
            ]
          },
          {
            ...
            "lessons": [
              {
                "id": "lesson166",
                "name": "Story Elements",
                "objective": "Students will identify characters, setting, and plot in simple stories"
              },
              {
                "id": "lesson167",
                "name": "Making Predictions",
                "objective": "Students will predict what will happen next in stories"
              },
              {
                "id": "lesson168",
                "name": "Retelling Stories",
                "objective": "Students will retell stories in their own words with proper sequence"
              }
            ]
          }
        ]
            ...
            "lessons": [
              {
                "id": "lesson172",
                "name": "Place Value",
                "objective": "Students will understand tens and ones in two-digit numbers"
              },
              {
                "id": "lesson173",
                "name": "Money Concepts",
                "objective": "Students will identify coins and understand basic money values"
              },
              {
                "id": "lesson174",
                "name": "Time and Calendar",
                "objective": "Students will read simple clocks and understand calendar concepts"
              }
            ]
          }
        ]
      ...
      {
        "id": "l3p3",
        "name": "Practice Book - World Cultures",
        "description": "Cultural awareness and global citizenship activities",
        "isbn": "978-1-234567-26-6",
        "isPracticeBook": true,
        "units": [
          {
            "id": "unit58",
            ...
            "lessons": [
              {
                ...
                "objective": "Students will identify and appreciate traditional clothing from different cultures"
              },
              {
                "id": "lesson176",
                "name": "Cultural Music",
                "objective": "Students will listen to and appreciate music from various cultures"
              },
              {
                "id": "lesson177",
                "name": "Global Games",
                "objective": "Students will learn and play traditional games from around the world"
              }
            ]
          },
          {
            ...
            "lessons": [
              {
                "id": "lesson178",
                "name": "Helping Others",
                "objective": "Students will understand how people help each other around the world"
              },
              {
                "id": "lesson179",
                "name": "Environmental Care",
                "objective": "Students will learn about protecting our planet for everyone"
              },
              {
                "id": "lesson180",
                "name": "Peace and Friendship",
                "objective": "Students will understand the importance of friendship across cultures"
              }
            ]
          }
        ]
